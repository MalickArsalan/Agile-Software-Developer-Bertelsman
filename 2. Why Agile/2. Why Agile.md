...
![Efficiency and effectiveness is a fine balancing act that Agile recommends](./Resources/2.2.2.0.EfficiencyVSEffectiveness.png)

- If you only focused on going fast, you prioritize efficiency
![Prioritizing efficiency](./Resources/2.2.2.1.PrioritizingEfficiency.png)
...
![Prioritizing effectiveness](./Resources/2.2.2.2.PrioritizingEffectiveness.png)

- Agile ensures a balanced approach whereby Agile Teams ensure there is a balance between speed and creativity.
![Balance approach](./Resources/2.2.2.3.BalancingEfficiencyAndEffectiveness.jpg)
...
![Balance approach](./Resources/2.2.3.0.WhyCompaniesSwitchingToAgile.png)
